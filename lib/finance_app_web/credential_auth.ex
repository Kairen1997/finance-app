defmodule FinanceAppWeb.CredentialAuth do
  use FinanceAppWeb, :verified_routes
  ...
  the current_credential:
      ...
      defmodule FinanceAppWeb.PageLive do
        use FinanceAppWeb, :live_view

        on_mount {FinanceAppWeb.CredentialAuth, :mount_current_credential}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{FinanceAppWeb.CredentialAuth, :ensure_authenticated}] do
