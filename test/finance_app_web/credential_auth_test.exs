defmodule FinanceAppWeb.CredentialAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FinanceAppWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_credential/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FinanceAppWeb.Endpoint.subscribe(live_socket_id)
