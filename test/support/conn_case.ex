defmodule FinanceAppWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use FinanceAppWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import FinanceAppWeb.ConnCase
    end
  end

  setup tags do
    FinanceApp.DataCase.setup_sandbox(tags)
